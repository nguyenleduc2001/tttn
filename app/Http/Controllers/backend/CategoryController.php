...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("backend.category.index", compact('category', 'title', 'html_parent_id', 'html_sort_order'));
    }
    ...
    public function show($id)
    {
        ...
        $categoryindex = Category::where('status', '!=', '0')
            ->orderBy('created_at', 'desc')
            ->get();
        $title = 'Chi Tiết Danh Mục';
        return view("backend.category.show", compact('title', 'category', 'categoryindex'));
    }
    ...
    public function edit($id)
    {
        ...
        return view("backend.category.edit", compact('title', 'html_sort_order', 'category', 'html_parent_id','categoryindex'));
    }
