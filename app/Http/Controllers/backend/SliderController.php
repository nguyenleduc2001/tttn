...
class SliderController extends Controller
{
    ...
    public function index()
    {
        ...
        $title = 'Tất Cả Banner';
        return view("backend.slider.index", compact('slider', 'title', 'html_sort_order'));
    }
    ...
    public function show($id)
    {
        ...
        $slider1 = Slider::where('status', '!=', '0')
            ->orderBy('created_at', 'desc')
            ->get();
        $title = 'Chi Tiết Banner';
        return view("backend.slider.show", compact('title', 'slider', 'slider1'));
    }
