...
class TopicController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("backend.topic.index", compact('topic', 'title', 'html_sort_order', 'html_parent_id'));
    }
    ...
    {
        $topicshow = Topic::where('status', '!=', '0')
            ->orderBy('created_at', 'desc')
            ->get();
        ...
        return view("backend.topic.show", compact('title', 'topic', 'topicshow'));
    }
    ...
    {
        $topicedit = Topic::where('status', '!=', '0')
            ->orderBy('created_at', 'desc')
            ->get();
        $title = 'Sửa Chủ Đề Bài Viết';
        ...
        return view("backend.topic.edit", compact('title', 'html_sort_order', 'topic', 'html_parent_id','topicedit'));
    }
