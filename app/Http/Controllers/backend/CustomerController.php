...
class CustomerController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $customer1 = User::where([['status', '!=', '0'], ['roles', '=', '0']])
        ->orderBy('created_at', 'desc')
        ->get();
        $title = 'Chi Tiết Khách hàng';
        return view("backend.customer.show", compact('title', 'customer', 'customer1'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.customer.edit', compact('title', 'customer', 'customer1'));
    }
