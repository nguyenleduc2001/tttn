    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-12 text-right">
                            ...
                            <a class="btn btn-sm btn-primary" href="{{ route('page.edit', ['page' => $page->id]) }} ">
                                <i class=" fas fa-edit"></i>
                            </a>
                            <a class="btn btn-sm btn-danger" href="{{ route('page.delete', ['page' => $page->id]) }}">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <img style="max-width: 400px" src="{{ asset('images/post/' . $page->image) }}"
                                        alt="" />
                ...
                <div class="col-7"><form action="{{ route('page.delete_multi') }}" name="form1" method="post">
                        @csrf
                        <!-- Default box -->
                        <div class="card">
                            <div class="card-header">
