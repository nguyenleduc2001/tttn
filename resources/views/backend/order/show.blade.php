                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-12 text-right">
                                ...
                                <div class="d-inline-block">
                                    <button class="btn btn-sm btn-success" name="status" type="submit" value="thanhtoan"
                                ...
                                <div class="d-inline-block">
                                    ...
                                    <button class="btn btn-sm btn-success" name="status" type="submit" value="dagiao"
                                        @if ($order->status != 5 && $order->status != 4) @disabled(true) @endif>
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-md-12 text-right">
                                ...
                                <div class="d-inline-block">
                                    <button class="btn btn-sm btn-success" name="status" type="submit"
                                        value="thanhtoan"
                                        @if ($order->status != 2 && $order->status != 1) @disabled(true) @endif>
                                        <i class="fa-brands fa-cc-amazon-pay"></i>Đã thanh toán
                                        @if ($order->status == 2)
                                ...
                                <div class="d-inline-block">
                                    <button class="btn btn-sm btn-warning" name="status" type="submit"
                                        value="vanchuyen"
                                        @if ($order->status != 4 && $order->status != 3) @disabled(true) @endif>
                                        <i class="fa-solid fa-plane-up"></i> Vận chuyển
                                        @if ($order->status == 4)
