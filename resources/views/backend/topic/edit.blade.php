    ...
    <section class="content">
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-5">
                        <form action="{{ route('topic.update', ['topic' => $topic->id]) }}" name="form1" method="post"
                                        ...
                                        <div class="col-md-12">
                                            <div>
                                                ...
                                                <input type="text" name="name" id="name" class="form-control"
                                                    placeholder="Việt Nam" value="{{ old('name', $topic->name) }}">
                                                @if ($errors->has('name'))
                                            ...
                                            <div>
                                                ...
                                                <textarea name="metakey" id="metakey" class="form-control" placeholder="Từ khóa"> {{ old('metakey', $topic->metakey) }}</textarea>
                                            ...
                                            <div>
                                                ...
                                                <textarea name="metadesc" id="metadesc" class="form-control" placeholder="Mô tả"> {{ old('metadesc', $topic->metadesc) }}</textarea>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="status" id="status" class="form-control">
                                                    <option value="1"
                                                        {{ old('status', $topic->status) == 1 ? 'selected' : '' }}>Xuất bản
                                                    </option>
                                                    <option value="2"
                                                        {{ old('status', $topic->status) == 2 ? 'selected' : '' }}>Chưa
                                                        xuất bản
                                                    </option>
