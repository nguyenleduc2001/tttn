<div class="row">
    <div class="col-7 mb-3 ">
        ...
        <input name="price_sale" id="price_sale" value="{{ old('price_sale') }}" type="number" class="form-control ">
    ...
    <div class="col-7 mb-3">
        ...
        <input name="date_begin" id="date_begin" value="{{ old('date_begin') }}" type="date" class="form-control ">
