    ...
    <section class="content">
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-5">
                        <form action="{{ route('post.update', ['post' => $post->id]) }}" name="form1" method="post"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div>
                                                        ...
                                                        <textarea name="metakey" id="metakey" class="form-control" placeholder="Từ khóa"> {{ old('metakey', $post->metakey) }}</textarea>
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="file" name="image" id="image"
                                                            class="form-control" value="{{ old('image', $post->image) }}">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="status" id="status" class="form-control">
                                                            <option value="1"
                                                                ...
                                                                bản</option>
                                                            <option value="2"
                                                                {{ old('status', $post->status) == 2 ? 'selected' : '' }}>
                                                                Chưa
                                                                xuất bản</option>
                                        ...
                                        <div class="tab-pane fade" id="content" role="tabpanel"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="detail" id="detail" cols="10" rows="2" class="form-control "
                                                    placeholder="Chi tiết">{{ old('detail', $post->detail) }}</textarea>
