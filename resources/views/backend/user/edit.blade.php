...
@section('content')
    <section class="content">
        <div class="content-wrapper">
            ...
            <!-- Main content -->
            <div class="row">
                <div class="col-5">  <section class="content">
                <form action="{{ route('user.update', ['user' => $user->id]) }}" name="form1" method="post"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input name="username" id="username" type="text" class="form-control "
                                            placeholder="vd:tk123" value="{{ old('username', $user->username) }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input name="name" id="name" type="text" class="form-control "
                                            placeholder="vd: " value="{{ old('name', $user->name) }}">
                                        @if ($errors->has('name'))
                                            <div class="text-danger">
                                                {{ $errors->first('name') }}
                                            </div>
