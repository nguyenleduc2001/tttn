    ...
    <section class="content">
        <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-5">
                    <section class="content">
                        <form action="{{ route('customer.update', ['customer' => $customer->id]) }}" name="form1"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input name="phone" id="phone" type="tel" class="form-control "
                                                    placeholder="" value="{{ old('phone', $customer->phone) }}">
                                                @if ($errors->has('phone'))
                                                    <div class="text-danger">
                                                        {{ $errors->first('phone') }}
                                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input name="name" id="name" type="text" class="form-control "
                                                    placeholder="vd: " value="{{ old('name', $customer->name) }}">
                                                @if ($errors->has('name'))
                                                    <div class="text-danger">
                                                        {{ $errors->first('name') }}
                                                    </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="radio" name="gender" id="nam" value="0"
                                                    {{ old('gender', $customer->gender) == 0 ? 'checked' : ' ' }}><label
                                                    for="nam">Nam</label>
                                                <input type="radio" name="gender" id="nu" value="1"
                                                    {{ old('gender', $customer->gender) == 1 ? 'checked' : ' ' }}><label
                                                    for="nu">Nữ</label>
                                            </div>
                                            <div class="mb-3">
                                                <label for="address">Địa chỉ</label>
                                                <input name="address" id="address" type="text"
                                                    class="form-control " placeholder="vd:"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="status" id="status" class="form-control">
                                                    <option value="1"
                                                        {{ old('status', $customer->status) == 1 ? 'selected' : ' ' }}>Xuất
                                                        bản
                                                    </option>
                                                    <option value="2"
                                                        {{ old('status', $customer->status) == 2 ? 'selected' : ' ' }}>
                                                        Không xuất
                                                        bản
                                                    </option>
                                                </select>
